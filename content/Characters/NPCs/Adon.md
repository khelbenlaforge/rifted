...
- **Divine Order: Thaumaturge** — Proficiency in Arcana and Religion; add WIS modifier to both (Arcana +6, Religion +6).
- **Arcane Initiate** — Two wizard cantrips (Sword Burst, True Strike) added as cleric cantrips.
- **Arcana Domain Spells** — Always prepared: Magic Missile, Magic Weapon, Nystul's Magic Aura.
