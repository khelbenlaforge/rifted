...
Acrobatics +4 · Arcana +7 · History +7 · Insight +4 · Investigation +10★ · Perception +4 · Persuasion +3 · Religion +7
...
| **Staff** *(Topple)* | M +2 | 5 ft. | 1d8−1 bludgeon (versatile 1d10−1) | — | — | — |
| **Unarmed Strike** | M +2 | 5 ft. | 1 bludgeon | — | — | — |
| **Dancing Lights** | — | 120 ft. | Up to 4 lights in a 10-ft radius; 1 min | Cantrip | V, S, M | Conc. |
| **Light** | — | Touch | Object sheds bright light 20 ft. + dim 20 ft.; 1 hr | Cantrip | V, S, M | — |
| **Mage Hand** | — | 30 ft. | Spectral hand; manipulate objects; 1 min | Cantrip | V, S | — |
| **Minor Illusion** | — | 30 ft. | Sound or image (both w/ Improved Illusions); 1 min | Cantrip | S | — |
| **Prestidigitation** | — | 10 ft. | Minor magical effect | Cantrip | V, S | — |
| **True Strike** | M +7 | 5 ft. | Weapon die + 4 psychic/radiant | Cantrip | S, M (weapon) | — |
| **Color Spray** | CON 15 | Self (15-ft cone) | Blinded until end of your next turn | 1st | V, S, M | — |
| **Detect Magic** | — | Self (30 ft.) | Sense magic auras and schools; 10 min | 1st | V, S | Conc. · Ritual |
| **Disguise Self** | — | Self | Change appearance; 1 hr | 1st | V, S | — |
| **Find Familiar** | — | 10 ft. | Summon a familiar | 1st | V, S, M† | Ritual |
| **Identify** | — | Touch | Learn magical properties of an item | 1st | V, S, M† | Ritual |
| **Illusory Script** | — | Touch | Hidden message on surface; 10 days | 1st | S, M† | Ritual |
| **Silent Image** | — | 60 ft. | Create a silent visual illusion; 10 min | 1st | V, S, M | Conc. |
| **Unseen Servant** | — | 60 ft. | Invisible servant; 1 hr | 1st | V, S, M | Ritual |
| **Blur** | — | Self | Attackers have disadv. against you; 1 min | 2nd | V | Conc. |
| **Invisibility** | — | Touch | Target invisible until attacks or casts; 1 hr | 2nd | V, S, M | Conc. |
| **Mirror Image** | — | Self | 3 illusory duplicates for 1 min | 2nd | V, S | — |
| **Phantasmal Force** | INT 15 | 60 ft. | Target perceives illusion; 2d8 psychic/turn; 1 min | 2nd | V, S, M | Conc. |
| **See Invisibility** | — | Self (30 ft.) | See invisible and ethereal creatures; 1 hr | 2nd | V, S, M | — |
| **Summon Beast** | — | 90 ft. | Summon beast spirit (CR = slot level); 1 hr | 2nd | V, S, M† | Conc. |
| **Fear** | WIS 15 | Self (30-ft cone) | Creatures Frightened; drop held objects; 1 min | 3rd | V, S, M | Conc. |
| **Hypnotic Pattern** | WIS 15 | 120 ft. (30-ft cube) | Creatures Incapacitated; 1 min | 3rd | V, S, M | Conc. |
| **Major Image** | — | 120 ft. (20-ft cube) | Sensory illusion (sight, sound, smell, temp.); 10 min | 3rd | V, S, M | Conc. |
| **Phantom Steed** | — | 30 ft. | Horse-like creature; speed 100 ft.; 1 hr | 3rd | V, S | Ritual |
| **Summon Fey** | — | 90 ft. | Fey spirit (mood = role); 1 hr | 3rd | V, S, M† | Conc. |

*† Find Familiar: M = 10+ gp of charcoal, incense, herbs (consumed)*
*† Identify: M = pearl worth 100+ gp*
*† Illusory Script: M = ink worth 10+ gp (consumed)*
*† Summon Beast: M = gilded feather, tuft of fur, or fish tail worth 200+ gp*
*† Summon Fey: M = gilded flower worth 300+ gp*
...
| Name | Atk / Save | Range | Damage / Effect | Lvl | Comp. | Recharge |
|------|------------|-------|-----------------|-----|-------|----------|
| **Counterspell** | CON 15 | 60 ft. | Counter a spell in progress; target makes CON save | 3rd | V, S | — |
| **Shield** | — | Self | +5 AC until start of next turn | 1st | V, S | — |
| **Silvery Barbs** | — | 60 ft. | Force reroll; ally gains adv. on next roll | 1st | V | — |

---

### Features

- **Arcane Recovery** — 1/LR after a Short Rest, regain spell slot levels up to 3 combined.
- **Ritual Adept** — Cast ritual spells without a slot (takes extra 10 min).
- **War Caster** — Advantage on CON saves to maintain concentration; cast spells as opportunity attacks.
- **Illusion Savant** — Copy illusion spells into spellbook for half gold and time.
- **Improved Illusions** — Free V component for illusion spells you cast; Minor Illusion creates both sound and image.
- **Memorize Spell** — After a Short Rest, swap one prepared spell for another of the same level.
- **Phantasmal Creatures** — Cast Phantasmal Force at 3rd level targeting up to 2 creatures simultaneously.
- **Investigation Expertise** — Investigation at double proficiency (★ in Skills).
- **Elven Lineage (High Elf)** — True Strike cantrip; Detect Magic 1/day at L1; Misty Step 1/day at L3.
...
- *Find Familiar* (1st) — 1 hr cast — Summon an animal as a magical familiar.
- *Identify* (1st) — 1 min cast — Learn the magical properties of an object or creature.
- *Illusory Script* (1st) — 1 min cast — Write a message only designated creatures can read; 10 days.
- *Phantom Steed* (3rd) — 1 min cast — Create a horse-like creature with speed 100 ft.; 1 hr.
