...
- Can forge documents in under an hour, maintaining multiple versions of the Guildmaster's signature
- Proficient in bardic magic, providing inspiration and support
- Maintains connections with the criminal underworld for intelligence
- Skilled in negotiation, employing Cutting Words to sway outcomes
- Capable of Sneak Attack when cornered, reflecting his rogue training
...
| | |
|---|---|
| **Level** | 9 (Rogue 5 / Bard 4) |
| **Class** | Rogue (Soulknife) / Bard (College of Lore) |
| **Race** | Human |
...
Deception +12★ · Insight +9★ · Investigation +8★ · Perception +9★ · Sleight of Hand +10★ · Stealth +10★ · Intimidation +8 · Performance +8 · Persuasion +8 · Acrobatics +6 · and all others (Jack of All Trades: +2 to non-proficient checks)
...
|------|------------|-------|-----------------|-----|-------|----------|
| **Light Crossbow** *(Slow)* | R +6 | 80/320 ft. | 1d8+2 pierce | — | — | — |
| **Unarmed Strike** | M +3 | 5 ft. | 1 bludgeon | — | — | — |
| **Psychic Whispers** | — | 30 ft. | Telepathic link ≤2 creatures; die-value hrs | — | — | 1 PED |
| **Guidance** | — | Touch | +1d4 to one ability check; 1 min | Cantrip | V, S | Conc. |
| **True Strike** | M +8 | 5 ft. | Weapon die + 4 psychic/radiant | Cantrip | S, M (weapon) | — |
| **Vicious Mockery** | CHA 16 | 60 ft. | 2d4 psychic; target disadv. on next atk | Cantrip | V | — |
| **Bane** | CHA 16 | 30 ft. | 3 targets −1d4 atk/saves; 1 min | 1st | V, S, M (blood) | Conc. |
| **Command** | WIS 16 | 60 ft. | One-word command; 1 rnd | 1st | V | — |
| **Sleep** | — | 60 ft. | 5d8 HP of creatures unconscious; 1 min | 1st | V, S, M | — |
| **Aid** | — | 30 ft. | 3 targets +5 max/current HP; 8 hr | 2nd | V, S, M | — |
| **Cloud of Daggers** | — | 60 ft. | 4d4 slash in 5-ft cube; 1 min | 2nd | V, S, M (sliver of glass) | Conc. |

### Bonus Actions

| Name | Atk / Save | Range | Damage / Effect | Lvl | Comp. | Recharge |
|------|------------|-------|-----------------|-----|-------|----------|
| **Bardic Inspiration** | — | 60 ft. | Grant ally 1d6 Bardic Inspiration die | — | — | 4×/LR |
| **Psychic Blade (2nd)** | M/R +6 | 5 ft. / 60 ft. | 1d4+2 psychic; only if no other weapons used | — | — | — |
...
| Name | Atk / Save | Range | Damage / Effect | Lvl | Comp. | Recharge |
|------|------------|-------|-----------------|-----|-------|----------|
| **Uncanny Dodge** | — | Self | Halve damage from one attack you can see | — | — | — |
| **Cutting Words** | — | 60 ft. | Expend Bardic Inspiration; subtract die from atk/check/save | — | — | 1 BI |
| **Gift of Gab** | — | Self | ≤2 creatures forget last 6 sec of conversation | 2nd | V, S, M† | — |
| **Silvery Barbs** | — | 60 ft. | Force reroll; ally gains adv. on next roll | 1st | V | — |

*† Gift of Gab: M = scroll piece worth 1+ sp (royalty)*

---

### Features

- **Expertise** — Deception, Insight, Investigation, Perception, Sleight of Hand, Stealth at double proficiency (★ in Skills).
- **Sneak Attack** — 3d6 extra damage once per turn when you have advantage or an ally is adjacent to the target.
...
- **Psychic Whispers** — Telepathic link with ≤2 creatures within 30 ft.
- **Cunning Strike** — Forgo 1d6 Sneak Attack damage for: Poison (CON 16 or Poisoned 1 min), Trip (DEX 16 or Prone), or Withdraw (no OA on your movement this turn).
- **Uncanny Dodge** — Reaction: halve damage from one attack you can see hitting you.
- **Jack of All Trades** — Add half Prof (+2) to ability checks that don't already use proficiency.
- **Bardic Inspiration** — BA; grant 1d6 die to an ally within 60 ft.; 4 uses/LR.
- **Cutting Words** — Reaction; expend Bardic Inspiration die; subtract roll from creature's atk/check/save (within 60 ft.).
- **Bonus Proficiencies (Lore)** — 3 extra skill proficiencies from Lore subclass.
...
**Ability:** Charisma | **Save DC:** 16 | **Attack Bonus:** +8
