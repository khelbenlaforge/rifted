...
Pale, wind-loose hair falls past her shoulders under a slate-blue headscarf, framing a face caught mid-smirk — half-lidded eyes, a faint blush across the cheeks, and a knowing, close-lipped smile that suggests she's already three steps ahead of the conversation. Small blue leaf-shaped earrings catch the light as she tucks a strand of hair back with one hand. Her top is a soft blue-grey with an oversized, folded collar — practical and a little worn-in, like everything else she owns.
...
A changeling's gift for wearing a new face suits Kili's hustle perfectly — she can be whoever the job needs her to be, and a College of Eloquence bard's silver tongue means people tend to believe her. Underneath the performances, though, is someone still looking for the one identity that doesn't come with an invoice attached.
...
**Saving Throws:** STR -2 . **DEX +5** . CON +3 . INT +1 . WIS +1 . **CHA +6**
...
| Name | Atk / Save | Range | Damage / Effect | Lvl | Comp. | Recharge |
|------|------------|-------|-----------------|-----|-------|----------|
| **Silvery Barbs** | — | 60 ft. | Trigger: seen creature succeeds atk/check/save within 60 ft.; it rerolls and uses lower; then chosen creature (can be self) gains adv. on next atk/check/save within 1 min | 1st | V | — |
...
**Spellcasting Ability:** Charisma (+4) . **Spell Save DC:** 14 . **Spell Attack Bonus:** +6
