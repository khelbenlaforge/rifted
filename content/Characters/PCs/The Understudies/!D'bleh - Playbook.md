...
*Companion to [[!D'bleh]] — regenerated from the synced Character Sheet on 2026-09-06. Rerun this skill after any character-sheet-sync update to keep it current.*

*Pronouns not set on the PC note — using they/them by default.*

*No Loadout Selection section — !D'bleh's known spells (True Strike, Vicious Mockery via Magic Initiate; Comprehend Languages) are fixed at level-up, not re-prepped after a Long Rest.*
...
**Movement:**
- Psychic Blade works at both melee and 60/120 ft range, so positioning is about Sneak Attack qualification (advantage, or an ally within 5 ft of the target) rather than staying at range.
