...
*Companion to [[Roberto]] — regenerated from the synced Character Sheet on 2026-09-06. Rerun this skill after any character-sheet-sync update to keep it current.*

## Combat Decision Flowchart

**Triage first — check every turn before anything else:**
- **Ally down or dying, out of reach →** **Healing Word** (BA, 60 ft., 2d4+4 HP) or **Spare the Dying** (Action, 15 ft., stabilizes at 0 HP with no healing) if you'd rather stabilize and act with your action elsewhere.
- **Ally down, adjacent →** **Cure Wounds** (Action, touch, 2d8+4 HP) for the bigger heal.
- **Someone about to be focused down and can afford to hold back →** **Sanctuary** (BA, 30 ft., WIS 14 negates; ends the instant they attack, cast, or deal damage).
...
- **Enemies hiding or invisible, or setting up an ally's next attack →** **Faerie Fire** *(always prepared)* (60 ft., 20-ft. cube, DEX 14 for creatures; outlined targets can't be Invisible and take adv. from seen attackers, Conc. 1 min).
- **Single tough target, setting up an ally's follow-up →** **Guiding Bolt** (R +6, 120 ft., 4d6 radiant; next attack vs. it has adv.).
- **Single target, flexible damage-or-heal →** **Divine Spark** (CON 14 or heal an ally you can see, 1d8+4, pool 2/LR shared).
- **Guaranteed chip damage on someone already hurt →** **Toll the Dead** (WIS 14, 60 ft., 1d8 necrotic, 1d12 if missing any HP).
- **Force a single word of obedience →** **Command** (WIS 14, 60 ft.).
- **Nothing better available →** **Mace** (M +1, 1d6-1 bludg.) or **Unarmed Strike**.

**Bonus Action** (independent of the above):
- **Ally down or needs a quick heal at range →** **Healing Word** (see Triage).
- **Someone about to be swarmed who can afford to hold back →** **Sanctuary** (see Triage).

**Reaction:**
- **Any attack roll in sight →** **Warding Flare** (see Triage).

**Movement:**
- Radiance of the Dawn and Burning Hands are self-centered — close to the cluster first. Scorching Ray, Guiding Bolt, Toll the Dead, and Command all reach 60 ft.+, so hanging back is fine when using those.
...
*Cleric prepares from its full class spell list — a Long Rest lets Roberto replace any or all of his 6 prepared spells (Command, Cure Wounds, Guiding Bolt, Healing Word, Sanctuary, Prayer of Healing). This doesn't count the four Light Domain spells (Burning Hands, Faerie Fire, Scorching Ray, See Invisibility), which are always prepared separately.*

**Dungeon / combat-heavy:**
- Swap in: *Spiritual Weapon* (2nd, Bonus Action to summon a spectral weapon that attacks for 1d8+4 force and can move 20 ft. as a Bonus Action, no concentration needed) and *Bless* (1st, Conc., +1d4 to attack rolls or saving throws for up to 3 creatures)
...
*Candidates pulled from the full Cleric spell list at accessible levels (query_5etools.py) — not just what's currently on the sheet.*
