...
**Saving Throws:** STR -1 . DEX +2 . CON +3 . INT +1 . **WIS +6** . **CHA +4**

**Resistances & Vulnerabilities:** None.

**Skills:** Acrobatics +2 . Animal Handling +6 . Arcana +5 . Athletics -1 . Deception +2 . History +1 . Insight +6 . Intimidation +2 . Investigation +1 . Medicine +6 . Nature +1 . Perception +4 . Performance +2 . Persuasion +2 . Religion +5 . Sleight of Hand +2 . Stealth +4 . Survival +6
**Languages:** Common *(not itemized further in Foundry — confirm any bonus language at table)*
...
|------|------------|-------|-----------------|-----|-------|----------|
| **Mace** | M +1 | 5 ft. | 1d6-1 bludg | — | — | — |
| **Unarmed Strike** | M +1 | 5 ft. | 0 bludg or Grapple/Shove | — | — | — |
| *Toll the Dead* (cantrip) | WIS 14 | 60 ft. | 1d8 necrotic on fail (1d12 if target missing any HP) | 0 | V, S | — |
| *Guidance* (cantrip) | — | Touch | Target adds 1d4 to one ability check using a chosen skill; 1 min | 0 | V, S | Conc. |
| *Spare the Dying* (cantrip) | — | 15 ft. | Stabilizes a creature at 0 HP | 0 | V, S | — |
| *Command* | WIS 14 | 60 ft. | Target obeys a 1-word command (Approach/Drop/Flee/Grovel/Halt) on fail | 1st | V | — |
| *Cure Wounds* | — | Touch | Heals 2d8+4 HP | 1st | V, S | — |
| *Guiding Bolt* | R +6 | 120 ft. | 4d6 radiant on hit; next atk vs target has adv. before end of your next turn | 1st | V, S | — |
| *Divine Spark* (Channel Divinity) | — / CON 14 | 30 ft. | 1d8+4: heal another creature you can see, or force it to make a CON save (dmg on fail, ½ on success), necrotic/radiant your choice | — | — | Pool 2/LR† |
| *Turn Undead* (Channel Divinity) | WIS 14 | 30 ft. | Undead you choose: Frightened + Incapacitated 1 min on fail, tries to flee as far as it can each turn; ends early if it takes dmg, or if you're Incapacitated or die | — | — | Pool 2/LR† |
| *Radiance of the Dawn* (Channel Divinity, Light) | CON 14 | Self (30-ft emanation) | Dispels magical darkness in range; chosen creatures take 2d10+3 radiant on fail, ½ on success | — | — | Pool 2/LR† |
| *Burning Hands* *(always prepared, Light)* | DEX 14 | Self (15-ft cone) | 3d6 fire on fail, ½ on success; unattended flammable objects in the cone catch fire | 1st | V, S | — |
| *Faerie Fire* *(always prepared, Light)* | DEX 14 | 60 ft. (20-ft cube) | Objects in cube auto-outlined; creatures also outlined on DEX-save fail; outlined targets can't be Invisible, shed Dim Light 10 ft., and take adv. from seen atkers; 1 min | 1st | V | Conc. |
| *Scorching Ray* *(always prepared, Light)* | R +6 ×3 | 120 ft. | 3 rays, 2d6 fire each on hit | 2nd | V, S | — |
| *See Invisibility* *(always prepared, Light)* | — | Self | See Invisible creatures/objects (as if visible) + the Ethereal Plane (appears ghostly); 1 hr | 2nd | V, S, M (pinch of talc) | — |

*† Channel Divinity: Divine Spark, Turn Undead, and Radiance of the Dawn share one pool — 2 uses/Long Rest, 1 regained on Short Rest.*

### Bonus Actions

| Name | Atk / Save | Range | Damage / Effect | Lvl | Comp. | Recharge |
|------|------------|-------|-----------------|-----|-------|----------|
| *Healing Word* | — | 60 ft. | Heals 2d4+4 HP | 1st | V | — |
| *Sanctuary* | — | 30 ft. | Wards a creature: anyone targeting it with an atk roll or a damaging spell must succeed WIS 14 or retarget/lose the atk or spell; ends if the warded creature attacks, casts, or deals dmg; 1 min | 1st | V, S, M‡ | — |

*‡ Sanctuary: M = a shard of mirror glass (not consumed)*
...
**Other Prepared Spells** *(non-Action cast time — not in the tables above)*

- *Prayer of Healing* (2nd level, 10-min cast, 30 ft.) — up to 5 creatures who stay in range for the full casting gain the benefit of a Short Rest and heal 2d8; a creature can't benefit again until its next Long Rest.
