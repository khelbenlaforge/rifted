...
- **[[Sir Gareth Ironhand]]** -- Paladin mentor at the Temple of [[Tyr]]; teaches the weight and meaning of an oath
...
| **Spear** *(Sap)* | M/R +6 | 5 ft. / 20/60 ft. | 1d6+4 pierce (versatile 1d8+4) | — | — | — |
| **Javelin** *(Slow)* | R +6 | 30/120 ft. | 1d6+4 pierce | — | — | — |
| **Light Crossbow** *(Slow)* | R +1 | 80/320 ft. | 1d8−1 pierce | — | — | — |
| **Holy Water** | R +4 | 20 ft. | 2d6 radiant (fiends/undead only) | — | — | 1 use |
| **Lay on Hands** | — | Touch | Restore HP from pool; cure disease/poison (5 HP) | — | — | Pool 15/LR |
| **Divine Sense** | — | Self (60 ft.) | Locate celestials, fiends, undead | — | — | 4×/LR |
...
| **Heroism** | — | Touch | Immune Frightened; +3 temp HP/turn; 1 min | 1st | V, S | Conc. |
...
| **Divine Smite** | — | Self | 2d8 radiant (+1d8/slot; +1d8 vs. undead/fiend) | 1st+ | V | — |
| **Inspiring Smite** | — | 30 ft. | Distribute 2d8+3 temp HP after Divine Smite | — | — | 1/SR |
| **Peerless Athlete** | — | Self | Adv. Athletics/Acrobatics; carry/jump ×2; 10 min | — | — | 1/SR |
| **Compelled Duel** | WIS 13 | 30 ft. | Target attacks only you; can't move away; 1 min | 1st | V | Conc. |
| **Divine Favor** | — | Self | Weapon attacks +1d4 radiant; 1 min | 1st | V, S | — |
| **Searing Smite** | — | Self | Next hit +1d6 fire; 1d6/turn (CON save ends); 1 min | 1st | V | — |
| **Shield of Faith** | — | 60 ft. | +2 AC; 10 min | 1st | V, S, M (prayer scroll) | Conc. |
| **Thunderous Smite** | — | Self | Next hit +2d6 thunder; STR save or pushed 10 ft. + prone | 1st | V | — |
| **Wrathful Smite** | — | Self | Next hit +1d6 psychic; WIS save or Frightened; 1 min | 1st | V | — |
...
- **Weapon Mastery** — Apply mastery to 2 weapons per turn; properties shown in action table. Current: Longsword (Sap), Spear (Sap).
...
- **Lay on Hands Pool** — 15 HP/LR. Each use: restore any amount from pool, or expend 5 HP to cure 1 disease or neutralize 1 poison.
...
- *Ceremony* (XGE, 1st) — 1 hr cast — Ritual blessing with 6 uses: Blessing, Coming of Age, Dedication, Funeral, Investiture, Wedding. Consumes 25 gp powdered silver.
...
**Gear:** Holy Symbol, Backpack, Blanket, Lamp, Hooded Lantern, Tinderbox, Manacles, Quiver, Robe, Traveler's Clothes, Gaming Set, Rations ×7
