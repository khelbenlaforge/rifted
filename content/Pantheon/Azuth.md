...
> | | |
> | ---- | --- |
> | Title | Lord of Spells, the God of Wizards |
> | Alignment | Lawful Neutral |
> | Domains | Knowledge, Arcana *(confirmed — 5etools deity table, PHB/SCAG)* |
> | Symbol | An upright, left hand's index and middle fingers pointing up, from a swirl of mist |

Domain:: Knowledge, Arcana
Alignment:: Lawful Neutral
Rank:: Lesser
Symbol:: An upright hand pointing up, from a swirl of mist

## Description

Azuth is the god wizards actually invoke: the Weave's most devoted student and advocate, though never its source — that belongs to Mystra alone. Wizards call on him when they scribe scrolls, inscribe magic circles, and memorize or cast spells. His relationship with Mystra is described as tutor-and-favorite-student turned genuine partnership: he acts as her adviser on the advancement and preservation of the magical arts, and the two are, by most accounts, lovers.
...
Formal temples to Azuth are rare, and his ordained clergy — collectively the **Magistrati** — smaller still, drawn from wizards, monks, and clerics alike. They cluster in large cities and align themselves with magical guilds, acting as a kind of administrative bridge between spellcasters and enforcing the customs that bind them. Among them, the elite are called **the Favored** — arcane paragons who push magical theory forward and are seen by the faithful as the high-water mark of magical science. The wider church has a reputation for being archaic in its traditions, pedantic in its debates, and detached from the ordinary world's problems.

Two suborders divide on temperament rather than doctrine: one distrusts sorcerers and views Mystra's more chaotic gifts with suspicion; the other welcomes cooperation between every kind of arcane practitioner, prizing the cumulative march of magical knowledge above any one caster's method.
