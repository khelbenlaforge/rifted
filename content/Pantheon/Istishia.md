...
- Recognise that change is the natural state of the world; resist stagnation.
- Seek to understand the currents that flow beneath the surface of events.
- Blend knowledge with elemental wisdom — water teaches what books cannot.
- Flow with your true nature; do not force yourself into a shape that does not fit.
...
- Istishia was named in play as one of the four elemental primordials.
- Istishia is weakening along with the other three elemental primordials.
- Istishia's realm is the elemental plane of water, inside the astral barrier.
